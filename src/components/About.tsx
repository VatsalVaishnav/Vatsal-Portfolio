      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.div
            ...
            className={`md:col-span-8 p-10 flex flex-col justify-center shadow-[0_0_60px_-10px_rgba(59,130,246,0.6)] hover:shadow-[0_0_80px_-5px_rgba(59,130,246,0.8)] hover:border-primary/50 ${baseCardStyle}`}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <motion.span
              whileHover={{ scale: 1.05 }}
              className="inline-flex items-center w-fit rounded-full border border-primary/40 bg-primary/20 px-4 py-1 text-xs font-semibold uppercase tracking-widest text-primary mb-6 shadow-[0_0_15px_rgba(59,130,246,0.5)]"
            >
              Background
            </motion.span>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-tight">
              Building <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-indigo-400 to-primary animate-gradient">digital solutions</span> that bridge design and engineering.
            </h2>
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                ...
                className={`p-6 flex flex-col items-center justify-center text-center shadow-[0_0_50px_-10px_rgba(236,72,153,0.5)] hover:shadow-[0_0_70px_-5px_rgba(236,72,153,0.7)] hover:border-secondary/50 ${baseCardStyle}`}
              >
                <div className="absolute inset-0 bg-gradient-to-tl from-secondary/10 via-transparent to-transparent opacity-70" />
                <span className="text-3xl font-bold text-white mb-2 relative z-10">{stat.value}</span>
          ...
          <motion.div
            variants={itemVariants}
            className={`md:col-span-7 shadow-[0_0_60px_-10px_rgba(139,92,246,0.5)] hover:shadow-[0_0_80px_-5px_rgba(139,92,246,0.7)] hover:border-violet-500/50 ${baseCardStyle}`}
          >
            <CardSpotlight className="p-10 h-full">
              <div className="absolute inset-0 bg-gradient-to-br from-violet-500/15 via-transparent to-transparent opacity-70" />
          ...
          <motion.div
            variants={itemVariants}
            className={`md:col-span-5 p-10 shadow-[0_0_50px_-10px_rgba(99,102,241,0.5)] hover:shadow-[0_0_70px_-5px_rgba(99,102,241,0.7)] hover:border-indigo-500/50 ${baseCardStyle}`}
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 via-transparent to-transparent opacity-70" />
            <h3 className="text-xl font-bold text-white mb-6 relative z-10">Core Expertise</h3>
            <div className="flex flex-wrap gap-2 relative z-10">
              {focusAreas.map((area) => (
                <span key={area} className="px-4 py-2 rounded-xl bg-white/10 border border-white/10 text-sm text-gray-300 hover:bg-indigo-500/30 hover:text-white transition-all cursor-default shadow-sm hover:shadow-indigo-500/20">
                  {area}
                </span>
              ))}
            </div>
          ...
          <motion.div
            variants={itemVariants}
            className={`md:col-span-12 p-10 shadow-[0_0_80px_-20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_100px_-15px_rgba(255,255,255,0.3)] hover:border-white/30 ${baseCardStyle}`}
          >
            <div className="absolute inset-0 bg-linear-to-r from-primary/10 via-violet-500/10 to-secondary/10 opacity-70" />
