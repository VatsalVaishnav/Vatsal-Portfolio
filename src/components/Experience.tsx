      ...
      <div className="mx-auto max-w-7xl px-6 py-8 sm:py-16 md:py-24">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-linear-to-br from-primary/10 via-black/50 to-secondary/10 px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 backdrop-blur-sm shadow-[0_0_50px_rgba(59,130,246,0.15)]">
          ...
          <div className="mb-16 text-center">
            ...
            <motion.h2 // Added motion.h2 to match original SectionHeading behavior if desired, or just h2. The original SectionHeading used motion.h2.
            ...
            >
              Delivering momentum across agencies and product teams.
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              From design sprints to production launches, I translate ideas into interactive experiences that convert.
            </motion.p>
          </div>
                ...
                >
                  ...
                  <div className="relative w-full">
                    <div className="flex flex-col gap-6 text-sm leading-relaxed text-gray-300">
                      <header>
                        <h3 className="text-xl font-semibold text-transparent bg-clip-text bg-linear-to-r from-primary to-secondary md:text-2xl drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]">
                          {item.role}
                        </h3>
                      </header>
